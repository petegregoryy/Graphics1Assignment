...
void Framework::SetTranX(int i) 
{

}

void Framework::SetTranY(int i) 
{

}

void Framework::SetTranZ(int i)
{

}

void Framework::SetRotX(float i)
{

}

void Framework::SetRotY(float i)
{

}

void Framework::SetRotZ(float i)
{
...
LRESULT Framework::MsgProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message)
	{
		...
		case WM_KEYDOWN:
			...
			if (wParam == VK_SPACE && wParam != VK_CONTROL) {
				SetTranY(1);
				break;
			}
			...
			if (wParam == VK_NUMPAD8 && wParam != VK_NUMPAD5)
			{
				SetRotZ(-0.1f);
				break;
			}
			if (wParam == VK_NUMPAD5 && wParam != VK_NUMPAD8)
			{
				SetRotZ(0.1f);
				break;
			}
			if (wParam == VK_NUMPAD4 && wParam != VK_NUMPAD6)
			{
				SetRotX(-0.1f);
				break;
			}
			if (wParam == VK_NUMPAD6 && wParam != VK_NUMPAD4)
			{
				SetRotX(0.1f);
				break;
			}
